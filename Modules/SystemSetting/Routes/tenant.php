...
//consultants Manage
Route::get('/all/consultant-data', 'ConsultantSettingController@getAllconsultantData')->name('getAllconsultantData');

Route::get('/allconsultants', 'ConsultantSettingController@index')->name('allconsultants')->middleware('RoutePermissionCheck:allconsultant');
Route::post('/storeCon', 'ConsultantSettingController@store')->name('consultant.store')->middleware('RoutePermissionCheck:consultant.store');
Route::get('/edit/{id}', 'ConsultantSettingController@edit')->middleware('RoutePermissionCheck:consultant.edit');
Route::post('/updateCon', 'ConsultantSettingController@update')->name('consultant.update')->middleware('RoutePermissionCheck:consultant.edit');
Route::post('/destroyCon', 'ConsultantSettingController@destroy')->name('consultant.delete')->middleware('RoutePermissionCheck:consultant.delete');
Route::get('/status/{id}', 'ConsultantSettingController@status')->name('consultant.change_status');

Route::get('/all/consultant-datamsg', 'ConsultantSettingController@getAllconsultantMSG')->name('getAllconsultantMSG');
Route::get('/allconsultantsmsg', 'ConsultantSettingController@indexmsg')->name('allconsultantsmsg');
Route::post('/submit-reply-msg', 'ConsultantSettingController@submitReplyMSG')->name('submitReplyMSG');

Route::get('/all/consultant-dataopp', 'ConsultantSettingController@getAllconsultantOPP')->name('getAllconsultantOPP');
Route::get('/allconsultantsopp', 'ConsultantSettingController@indexopp')->name('allconsultantsopp');
Route::post('/submitZoomLink', 'ConsultantSettingController@submitZoomLink')->name('submitZoomLink');

Route::get('/all/consultant-dataav', 'ConsultantSettingController@getAllconsultantAV')->name('getAllConsultantAV');
Route::get('/allconsultantsav', 'ConsultantSettingController@indexav')->name('allconsultantsav');
Route::post('/storeAV', 'ConsultantSettingController@storeav')->name('consultantsav.store');
