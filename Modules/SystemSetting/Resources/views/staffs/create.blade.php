                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary-input filePlaceholder courseLabel" type="text" id=""
                                            ...
                                            <div class="multi_btn">
                                                ...
                                                <button type="button" data-table="users"
                                                        data-name="image"
                                                        data-id="0"
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary-input filePlaceholder courseLabel2" type="text" id=""
                                                   placeholder="Browse file" readonly="">
                                            <div class="multi_btn">
                                                <button class="" type="button">
                                                    <label class="primary-btn small fix-gr-bg"
                                                           for="document_file_2">{{ __('common.Browse') }}</label>
                                                    <input type="file" class="d-none fileUpload courseLabel2"
