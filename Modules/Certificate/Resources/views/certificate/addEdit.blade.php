                        ...
                        <div class="col-xl-12">
                            <div class="primary_input">
                                <label class="primary_input_label"
                                    for="">{{ __('certificate.Background Image') }} <strong class="text-danger">*</strong>
                                ...
                                <div class="input-effect">
                                    ...
                                    <ul>
                                        <li class="mt-2"><label class="primary_checkbox d-flex mr-12">
                                                <input type="radio" class="courseCheckbox certificateType" id="courseCheckbox"
                                                    name="type" value="course" {{ isset($certificate) ? ($certificate->type == null || $certificate->type=='course' ) ? 'checked':'':'checked' }}>
                                                <span class="checkmark mr-2"></span> {{ __('courses.Course') }}
                                            </label></li>
                                        @if (isModuleActive('CPD'))
                                            <li class="mt-2"><label class="primary_checkbox d-flex mr-12">
                                                    <input type="radio" class="cpdCheckbox certificateType" id="cpdCheckbox"
                                                        name="type" value="cpd" {{ isset($certificate) ? $certificate->type == 'cpd' ? 'checked':'':'' }}>
                    ...
                    <div class="row mt-25 padding_40">
                        <div class="col-lg-12">
                            <div class="input-effect">
                                ...
                                <textarea {{ $errors->has('body') ? ' autofocus' : '' }} placeholder="{{ __('certificate.Body') }}"
                                    class=" change-input form-control {{ $errors->has('body') ? ' is-invalid' : '' }}" id="body" rows="5"
