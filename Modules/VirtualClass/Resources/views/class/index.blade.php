                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            ...
                                            <select {{ $errors->has('category') ? ' autofocus' : '' }}
                                                ...
                                                <option data-display="{{$category->name}}" value="{{$category->id}}" @selected(isset($class) && $category->id==$class->category_id)>{{$category->name}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <div class="primary_file_uploader">
                                                    <input class="primary-input filePlaceholder courseLabel" type="text"
                                                           placeholder="{{ isset($class) && $class->course->thumbnail ? showPicName($class->course->thumbnail) : __('virtual-class.Browse Image file') }}"
                                                           readonly="" {{ $errors->has('image') ? ' autofocus' : '' }}>
                                                    <div class="multi_btn">
                                                        <button class="" type="button">
                                                            <label class="primary-btn small fix-gr-bg"
                                                                   for="document_file">{{ __('common.Browse') }}</label>
                                                            <input type="file" class="d-none fileUpload courseLabel"
                                                                   name="image"
                                                                   id="document_file">
                                                        </button>
                                                        <button type="button" data-table="courses"
                                                                data-name="thumbnail"
                                                                data-id="{{ isset($class)?$class->course->id:0}}"
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input placeholder="Start Date"
                                                                       ...
                                                                       name="start_date"
                                                                       value="{{isset($class)?getJsDateFormat(\Carbon\Carbon::parse($class->start_date)->format(getActivePhpDateFormat())): getJsDateFormat(date('m/d/Y'))}}"
                                                                       autocomplete="off">
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input placeholder="End Date"
                                                                       ...
                                                                       name="end_date"
                                                                       value="{{isset($class)?  getJsDateFormat(\Carbon\Carbon::parse($class->end_date)->format(getActivePhpDateFormat())) : getJsDateFormat(date('m/d/Y'))}}"
                                                                       autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <button class="" type="button">
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input placeholder="Date" readonly
                                                                       ...
                                                                       id="start_date" type="text"
                                                                       name="date"
                                                                       value="{{isset($class) && $class->type == 0 ? getJsDateFormat(\Carbon\Carbon::parse($class->start_date)->format(getActivePhpDateFormat())) : getJsDateFormat(date('m/d/Y'))}}"
                                                                       autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <button class="" type="button">
...
{{ $errors->has('recurring_repect_day') ? ' autofocus' : '' }}
                                        class="primary_select {{ $errors->has('recurring_repect_day') ? ' is-invalid' : '' }}"
                                                        ...
                                                        <option data-display=" Select *" value="">
                                                            {{ __('zoom.Zoom Recurring Repeat') }}<span
                                                                class="required_mark">*</span>
                                                        </option>
                                                        @for ($i = 1; $i <= 15; $i++)
                                            <option value="{{ $i }}"
