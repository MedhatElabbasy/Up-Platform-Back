                            ...
                            <div class="white-box  student-details header-menu">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12 mt-30-md">
                                            <label class="primary_input_label"
                                                   for="type">{{ __('نوع الاختبار') }}</label>
                                            <select {{ $errors->has('type') ? ' autofocus' : '' }}
                                                    class="primary_select{{ $errors->has('type') ? ' is-invalid' : '' }} select_section"
                                                    id="type" name="type">
                                                    <option value="course">اختبار تدريبي</option>
                                                    <option value="bundle">اختبار اقتراح مسار</option>
                                            </select>
                                            @if ($errors->has('type'))
                                                <span class="invalid-feedback invalid-select" role="alert">
