                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select {{ $errors->has('question_type') ? ' autofocus' : '' }}
                                                ...
                                                <option
                                                    value="M" {{isset($bank)? $bank->type == "M"? 'selected': '' : ''}} {{ old('question_type') == 'M'? 'selected': '' }}> {{__('quiz.Multiple Choice')}}</option>
                                                <option
                                                    value="S" {{isset($bank)? $bank->type == "S"? 'selected': '' : ''}} {{ old('question_type') == 'S'? 'selected': '' }}> {{__('quiz.Short Answer')}} </option>
                                                <option
                                                    value="L" {{isset($bank)? $bank->type == "L"? 'selected': '' : ''}} {{ old('question_type') == 'L'? 'selected': '' }}> {{__('quiz.Long Answer')}} </option>
