...
class CreatePaymentMethodCredentialsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('payment_method_credentials', function (Blueprint $table) {
            $table->id();
            //Tap
            $table->string('Tap_API_KEY')->nullable();
            $table->string('Tap_API_SECRET')->nullable();
            $table->string('Tap_URL')->nullable();
            $table->boolean('tap_mode')->default(true);
            $table->string('Tap_success_url')->nullable();
            $table->string('Tap_fail_url')->nullable();
            $table->boolean('IS_TAP_LOCALHOST')->default(true);
            ...
            $table->string('PESAPAL_CALLBACK')->nullable();
            //MOBILPAY
        ...
        $settings = [
            ...
            'Tap_API_SECRET' => env('Tap_API_SECRET'),
            'Tap_URL' => env('Tap_URL'),
            'IS_TAP_LOCALHOST' => env('IS_TAP_LOCALHOST'),
            'Tap_success_url' => env('Tap_success_url'),
            'Tap_fail_url' => env('Tap_fail_url'),
            ...
            'PESAPAL_CALLBACK' => env('PESAPAL_CALLBACK'),
