...
"
                                                ...
                                                @elseif($payment_method->method=='Mobilpay')
                                                    ...
                                                    @elseif($payment_method->method=='Tap')
                                                    <div class="row mb-25">
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <input
                                                                            class="primary-input form-control"
                                                                            type="text" name="Tap_API_KEY"
                                                                            id="Tap_API_KEY"
                                                                            required
                                                                            autocomplete="off"
                                                                            value="{{getPaymentEnv('Tap_API_KEY')? getPaymentEnv('Tap_API_KEY') : ''}}">
                                                                        <label>{{__('setting.Tap_API_KEY')}}
                                                                            <span></span>
                                                                        </label>
                                                                        <span class="focus-border"></span>
                                                                        <span
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <input
                                                                            required
                                                                            class="primary-input form-control{{ $errors->has('Tap_API_SECRET') ? ' is-invalid' : '' }}"
                                                                            type="text" name="Tap_API_SECRET"
                                                                            id="Tap_API_SECRET"
                                                                            autocomplete="off"
                                                                            value="{{getPaymentEnv('Tap_API_SECRET')? getPaymentEnv('Tap_API_SECRET') : ''}}">
                                                                        <label>{{__('setting.Client Secret')}}
                                                                            <span></span> </label>
                                                                        <span class="focus-border"></span>
                                                                        <span
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <input
                                                                            required
                                                                            class="primary-input form-control{{ $errors->has('Tap_success_url') ? ' is-invalid' : '' }}"
                                                                            type="text" name="Tap_success_url"
                                                                            id="Tap_success_url"
                                                                            autocomplete="off"
                                                                            value="{{getPaymentEnv('Tap_success_url')? getPaymentEnv('Tap_success_url') : ''}}">
                                                                        <label>{{__('setting.success url')}}
                                                                            <span></span> </label>
                                                                        <span class="focus-border"></span>
                                                                        <span
                                                                            class="modal_input_validation red_alert"></span>
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <input
                                                                            required
                                                                            class="primary-input form-control{{ $errors->has('Tap_fail_url') ? ' is-invalid' : '' }}"
                                                                            type="text" name="Tap_fail_url"
                                                                            id="Tap_fail_url"
                                                                            autocomplete="off"
                                                                            value="{{getPaymentEnv('Tap_fail_url')? getPaymentEnv('Tap_fail_url') : ''}}">
                                                                        <label>{{__('setting.fail url')}}
                                                                            <span></span> </label>
                                                                        <span class="focus-border"></span>
                                                                        <span
                                                                            class="modal_input_validation red_alert"></span>
                                                                        ...
                                                                        <div class="">
                                                                            <div class="text-left float-left">
                                                                                <label
                                                                                    ...
                                                                                    for="mode_check_{{$payment_method->id}}">
                                                                                    <input type="radio"
                                                                                           name="IS_TAP_LOCALHOST"
                                                                                           @if(getPaymentEnv('IS_TAP_LOCALHOST') == true)
                                                                                               checked
                                                                                           @endif
                                                                            ...
                                                                            <div class="text-left float-left">
                                                                                ...
                                                                                <label class="primary_checkbox d-flex mr-12"
                                                                                    ...
                                                                                    <input type="radio"
                                                                                           name="IS_TAP_LOCALHOST"
                                                                                           id="live_mode_check_{{$payment_method->id}}"
                                                                                           @if(getPaymentEnv('IS_TAP_LOCALHOST') == false)
                                                                                               checked
                                                                                           @endif
                                                                                           value="2"
                                                                                           class="common-radio relationButton read-only-input">
