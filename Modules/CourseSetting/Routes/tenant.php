...
Route::group(['prefix' => 'admin/course', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/new/my-exam', 'CourseSettingController@addNewCourse')->name('myExam.store')->middleware('RoutePermissionCheck:course.store');
    Route::get('/new/my-exam-course', 'CourseSettingController@addNewCourse')->name('myExamCourse.store')->middleware('RoutePermissionCheck:course.store');
