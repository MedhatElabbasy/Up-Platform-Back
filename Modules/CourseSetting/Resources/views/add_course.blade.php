                            ...
                            <div role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="primary_input mb-35">
                                            <label class="primary_input_label d-flex"
                                                   for="">{{__('courses.Course')}} {{__('courses.target')}}
                                                @includeIf('aicontent::inc.button' , ['selected_template' => 3,'slug'=>'course-long-description'])
                                            </label>
                                            <textarea class="lms_summernote"
                                                      name="target[{{$language->code}}]" id="addAbout"
                                                      cols="30"
                                                      rows="10"></textarea>
                                        </div>
                                    </div>
