    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        ...
        <div class="white_box mb_30  student-details header-menu">
            <div class="white_box_tittle list_header">
                @if (request()->is('admin/course/new/my-exam'))
                    <h4>اختبار </h4>
                @else
            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('AdminSaveCourse') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        @if (request()->is('admin/course/new/my-exam'))
                            <div style="display: none;" class="{{ $required_type ? 'col-xl-4' : 'col-xl-6' }}  ">
                                <div class="primary_input " style="display: none;">
                                    <div class="row">
                                        {{-- <div class="col-md-12 ">
                                            <label class="primary_input_label" for=""> {{ __('courses.Type') }}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <label class="primary_input_label" for="">
                                                {{ __('courses.Required Type') }} <strong class="text-danger">*</strong>
                                            </label>
                                        </div>
                                        <div class="col-md-4  col-sm-6 mb-25">
                                            <label class="primary_checkbox d-flex mr-12">
                            ...
                            <div style="display: none;" class=" {{ $required_type ? 'col-xl-4' : 'col-xl-6' }} "
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6 mb-25">
                                            <label class="primary_checkbox d-flex mr-12">
                                                <input type="radio" class="drip0" id="drip0" name="drip"
                                                    value="0" checked>
                                        ...
                                        {{-- <div class="col-md-4 col-sm-6 mb-25">
                                        <label class="primary_checkbox d-flex mr-12">
                                            <input type="radio" class=" drip1" id="drip1" name="drip"
                                                value="1">
                        ...
                        @if (request()->is('admin/course/new/my-exam'))
                            @if (\Illuminate\Support\Facades\Auth::user()->role_id != 2)
                                <div  style="display: none" class="col-xl-6">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="quize_type">{{ __('نوع الأختبار ') }}
                                        </label>
                                        <select class="primary_select category_id" name="quize_type" id="quize_type"
                                            {{ $errors->has('quizeType') ? 'autofocus' : '' }}>
                                            <option data-display="{{ __('common.Select') }} {{ __('نوع الأختبار') }}"
                                                value="">{{ __('common.Select') }}
                                                {{ __('نوع الأختبار') }} </option>


                                            {{-- <option value="1"> اختبار تدريبي</option> --}}
                                            <option value="2" selected> اختباراتي </option>
                                        </select>
                                    </div>
                                </div>
                            @endif
                            {{-- exam type  local inter  --}}
                            @if (\Illuminate\Support\Facades\Auth::user()->role_id != 2)
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="exam_type">{{ __('نوع الأختبار') }}</label>
                                    <select class="primary_select category_id" name="exam_type" id="exam_type" {{ $errors->has('exam_type') ? 'autofocus' : ''  }} >
                                        <option data-display="{{ __('common.Select') }} {{ __('نوع الأختبار') }}" value="">{{ __('common.Select') }} {{ __('نوع الأختبار') }}</option>
                                ...
                                <div class="col-xl-6">
                                    <div class="primary_input mb-25">
                                        ...
                                        <select class="primary_select category_id" name="quize_type" id="quize_type"
                                            ...
                                            <option value="1"> اختبار تدريبي</option>
                                            <option value="2"> اختباراتي </option>
                                        </select>
                                    </div>
                                </div>
                            @endif
                        ...
                        @foreach ($LanguageList as $key => $language)
                            <div role="tabpanel"
                                    ...
                                    <div class="col-xl-12">
                                        <div class="primary_input mb-25">
                                            <label class="primary_input_label d-flex"
                                                ...
                                                @includeIf('aicontent::inc.button', [
                                                    'selected_template' => 1,
                                                    'slug' => 'course-title',
                                                ])
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="primary_input mb-25">
                                            <label class="primary_input_label d-flex" for="certificate_name">
                                                اسم الشهادة <span class="required_mark">*</span>
                                            </label>

                                            <input class="primary_input_field" name="certificate_name" placeholder="-" id="certificate_name" type="text" {{ $errors->has('certificate_name') ? 'autofocus' : '' }} value="{{ old('certificate_name') }}">
                        ...
                        <div class="col-xl-{{ $col_size }} courseBox mb_30">
                            <select class="primary_select category_id" name="category" id="category_id"
                                ...
                                @foreach ($categories as $category)
                                    <option data-display="{{ $category->name }}" value="{{ $category->id }}">
...
@else
    ...
    @endif
                        ...
                        <div class="col-xl-12 makeResize responsiveResize" id="">
                        ...
                        <div class="col-xl-12 makeResize responsiveResize" id="durationBox">
                            <div class="primary_input mb-25">
                            ...
                            <div class="col-xl-4 makeResize responsiveResize" id="">
                                <div class="primary_input mb-25">
                                    ...
                                    <input class="primary_input_field" name="org_leaderboard_point"
                                        placeholder="{{ __('org.Leaderboard point') }}" id="" min="0"
                                        step="any" type="number" value="{{ old('org_leaderboard_point') }}"
                                        {{ $errors->has('org_leaderboard_point') ? 'autofocus' : '' }}>
                                </div>
                            </div>
                        @endif
                    </div>
                            ...
                            <div class="col-xl-4" id="price_div">
                                <div class="primary_input mb-25">
                                    ...
                                    <input class="primary_input_field" name="price" min="0" placeholder="-"
                                        id="addPrice" type="text" value="{{ old('price') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-20" id="discountDiv">
                            ...
                            <div class="col-xl-4" id="discount_price_div" style="display: none">
                                <div class="primary_input mb-25">
                                    ...
                                    <input class="primary_input_field" min="0" name="discount_price"
                                        placeholder="-" id="addDiscount" type="text"
                        ...
                        <div class="row mt-20">
                            <div class="col-lg-3 mb-25">
                                <div class="checkbox_wrap d-flex align-items-center mt-40">
                                    ...
                                    <label class="mb-0">{{ __('courses.Is upcoming course?') }}</label>
                                </div>
                            </div>

                            <div class="col-xl-3 upcoming_course_div publish_date_div">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="">{{ __('courses.Publish Date') }}
                                    </label>
                                            ...
                                            <div class="col">
                                                <div class="">
                                                    <input placeholder="{{ __('courses.Publish Date') }}"
                                                        ...
                                                        value="{{ old('publish_date') }}" autocomplete="off">
                                                </div>
                                            </div>
                                            <button class="" type="button">
                            ...
                            <div class="col-lg-3 mb-25 upcoming_course_div">
                                <div class="checkbox_wrap d-flex align-items-center mt-40">
                                    ...
                                    <label class="mb-0">{{ __('courses.Is Allow Prebooking?') }}</label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 mb-25 upcoming_course_div booking_amount_div">
                                <div class="primary_input mb-25">
                                    ...
                                    <input class="primary_input_field booking_amount_field" name="booking_amount"
                                        placeholder="{{ __('courses.Booking Amount') }}" id="booking_amount"
                                        type="number" value="{{ old('booking_amount') }}">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mt-25">
                            ...
                            <input class="primary_input_field " name="access_limit"
                                placeholder="{{ _trans('courses.Access Limit') }}" id="access_limit" type="number"
                            ...
                            <div class="primary_input mb-35">
                                ...
                                <div class="primary_file_uploader">
                                    ...
                                    <div class="multi_btn">
                                        ...
                                        <button type="button" data-table="courses" data-name="thumbnail" data-id="0"
