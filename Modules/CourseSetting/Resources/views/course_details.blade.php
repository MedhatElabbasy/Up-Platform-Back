                                                ...
                                                <div class="row">
                                                    ...
                                                    @if (\Illuminate\Support\Facades\Auth::user()->role_id != 2)
                                                        <div class="col-xl-6">
                                                            <div class="primary_input mb-25">
                                                                <label class="primary_input_label"
                                                                       for="quize_type">{{ __('نوع الأختبار ') }}
                                                                </label>
                                                                <select class="primary_select category_id"
                                                                        name="quize_type" id="quize_type"
                                                                    {{ $errors->has('quizeType') ? 'autofocus' : '' }}>
                                                                    <option
                                                                        data-display="{{ __('common.Select') }} {{ __('نوع الأختبار') }}"
                                                                        value="">{{ __('common.Select') }}
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-{{ $col_size }} courseBox mb-25">
                                                            <select class="primary_select edit_category_id"
                                                                ...
                                                                <option data-display="{{$category->name}}" value="{{$category->id}}" @selected($category->id==$course->category_id)>{{$category->name}}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="col-xl-6 makeResize responsiveResize" id="">
                                                        ...
                                                        <div class="col-xl-6 makeResize  responsiveResize mb-25">
                                                            <div class="primary_input ">
                                                    ...
                                                    <div class="row mt-20">
                                                        <div class="col-xl-12">
                                                            <div class="primary_input mb-35">
                                                                ...
                                                                <div class="primary_file_uploader">
                                                                    <input
                                                                        class="primary-input filePlaceholder courseLabel"
                                                                        type="text"
                                                                        id=""
