                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="defaultHost {{isModuleActive('Org')?'d-none':''}}">
                                <div class="input-effect mt-2 pt-1">
                                    ...
                                    <select class="primary_select category_id host_select" name="host"
                                        ...
                                        @if (isModuleActive('H5P'))
                                            <option value="H5P" @if (empty(@$editLesson) == 'H5P') selected @endif>
                                                H5P
                                            </option>
                                        @endif
                                ...
                                <div class="input-effect mt-2 pt-1"
                                     ...
                                     style="display: @if((isset($editLesson) && (($editLesson->host=="Vimeo") || ($editLesson->host=="BunnyStream") ||  ($editLesson->host=="Youtube")|| ($editLesson->host=="VdoCipher")|| ($editLesson->host=="Iframe")||  ($editLesson->host=="URL")) ) || !isset($editLesson)) none  @endif">
                                    <input type="file" class="filepond"
                                           name="file"
                                           data-file="{{isset($editLesson)? $editLesson->video_url:''}}"
                                           id="">
