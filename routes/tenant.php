...
//club
Route::group(['prefix' => 'club', 'middleware' => ['auth', 'admin']], function () {

    Route::get('/club_events',[CLubEventListController::class, 'index'])->name('club_events.index');
    Route::get('/club_events/create', [CLubEventListController::class, 'create'])->name('club_events.create');
    Route::post('/club_events',  [CLubEventListController::class, 'store'])->name('club_events.store');
    //event user list
    Route::get('/club_events/users',[CLubEventUsersListController::class, 'index'])->name('club_events.user.index');
    // Route::get('/club_events/{club_event}', [CLubEventListController::class, 'show'])->name('club_events.show');
    Route::get('/club_events/{club_event}/edit', [CLubEventListController::class, 'edit'])->name('club_events.edit');
    Route::put('/club_events/{club_event}',  [CLubEventListController::class, 'update'])->name('club_events.update');
    Route::delete('/club_events/{club_event}',  [CLubEventListController::class, 'destroy'])->name('club_events.destroy');

});

///prizes
Route::group(['prefix' => 'prize', 'middleware' => ['auth', 'admin']], function () {

    Route::get('/wheel-prize', [WhellPrizeController::class, 'index'])->name('whell.index_prize');
    Route::get('/wheel-prize/create', [WhellPrizeController::class, 'create'])->name('whell.create_prize');
    Route::post('/wheel-prize', [WhellPrizeController::class, 'store'])->name('whell.store_prize');
    Route::get('/wheel-prize/{id}/edit', [WhellPrizeController::class, 'edit'])->name('whell.edit_prize');
    Route::put('/wheel-prize/{id}', [WhellPrizeController::class, 'update'])->name('whell.update_prize');
    Route::delete('/wheel-prize/{id}', [WhellPrizeController::class, 'destroy'])->name('whell.destroy_prize');
...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    //     }
    // })->name('frontendHomePage')->middleware('auth');
...
//Route::get('profile/{username}', 'StudentController@myDashboard');
