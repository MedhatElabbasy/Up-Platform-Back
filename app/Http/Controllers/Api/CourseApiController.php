...
class CourseApiController extends Controller
{
    ...
    {
        $courses = Course::where('type', '1')->with('user', 'instructor', 'category', 'subCategory', 'lessons', 'lessons.quiz', 'reviews', 'comments')->where('status', 1)->where('scope', 1)->latest()->get()
        ->map(function($i) {
    ...
    public function getCourseDetails($id)
    {
        ...
        $course = Course::with('courseLevel', 'user', 'instructor', 'category', 'subCategory', 'chapters', 'lessons', 'lessons.quiz', 'comments', 'files')->find($id);
