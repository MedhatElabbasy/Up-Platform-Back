        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-title">
                    <h3 class="mb-0">@lang('common.Welcome') {{@Auth::user()->role->name}} @lang('common.To') {{Settings('site_title')}}</h3>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                labels: enroll_day,
                datasets: [{
                    label: '{{__('dashboard.Daily Wise Enroll Status for')}} {{\Carbon\Carbon::now()->translatedFormat('F')}}',
                    data: enroll_count,
