                                ...
                                <table id="lms_table" class="table Crm_table_active3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">{{ $i->question }}</td>
                                            <td scope="col">{{ count($i->answers) }}</td>
                                            <td>
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a href="{{route('suggested-path-test.choices.index', $i->id)}}"
                                                           class="dropdown-item"
                                                        >الاختيارات</a>

                                                    <a href="{{route('suggested-path-test.update', $i->id)}}"
                                                        class="dropdown-item"
                                                    >تعديل</a>

                                                        <button data-toggle="modal"
                                                                data-target="#deleteModel"
                                                                onclick="document.getElementById('ModelDeleteId').value='{{$i->id}}'"
                                                                class="dropdown-item"
