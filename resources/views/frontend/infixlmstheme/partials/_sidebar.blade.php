...
@else
    <nav class="sidebar colorbar gg">
        <div class="logo colorbar  d-flex justify-content-between bg-white gg">
            <a href="{{url('/')}}">
                
    <img src="{{getCourseImage(Settings('logo3')?Settings('logo3'):'public/uploads/settings/logo1.png')}}" alt=""
        style="width: 200px; height: 150px;">
      
</a>

            <div class="sidebar_close_icon d-lg-none gg">
                <i class="ti-close"></i>
            </div>
        </div>
          <br> <br>    <br> <br>
        <div class="sidebar_iner colorbar gg">
            <div class="sidebar-user text-center">
                ...
                <div class="sidebar-badge">
                    ...
                    @foreach(\Illuminate\Support\Facades\Auth::user()->userLatestBadges as $badge)
                        ...
                        @endphp
                        <div class="sidebar-badge-list gg"
            ...
            <ul class="list-unstyled pt-0">
               ...
               <li>
                    <a href="{{auth()->user()->username?route('profileUniqueUrl',auth()->user()->username):''}}"
                       class="  d-flex align-items-center {{ routeIs('profileUniqueUrl')  ? 'active' : '' }}">
                        <div class="menu_icon">
                           <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 0C4.486 0 0 4.486 0 10C0 15.514 4.486 20 10 20C15.514 20 20 15.514 20 10C20 4.486 15.514 0 10 0ZM10 2C14.416 2 18 5.584 18 10C18 14.416 14.416 18 10 18C5.584 18 2 14.416 2 10C2 5.584 5.584 2 10 2ZM10 6C8.346 6 7 7.346 7 9C7 10.654 8.346 12 10 12C11.654 12 13 10.654 13 9C13 7.346 11.654 6 10 6ZM4 14C4.166 12.084 6.916 11 10 11C13.084 11 15.834 12.084 16 14H4Z" fill="currentColor"/>
</svg>

                        </div>
                        <span>{{__('common.My Profile')}} </span>
                    </a>
                </li>
