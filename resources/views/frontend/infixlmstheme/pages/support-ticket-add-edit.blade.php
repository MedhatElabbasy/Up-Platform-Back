                ...
                <div class='row'>
                    <div class="col-md-6">
                        <div class="support_main_card_content_item">
                            ...
                            <input type="text" value="{{$new?old('subject'):$ticket->subject}}" class="primary_input4"
                                   name="subject"
                    ...
                    <div class="col-md-3">
                        <div class="support_main_card_content_item">
                            <label for="#" class='primary_label2'>{{__('common.Category')}} <span class="required_mark">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="support_main_card_content_item">
                            <label for="#" class='primary_label2'>{{__('common.Priority')}} <span class="required_mark">*</span></label>
                    ...
                    <div class="col-sm-12">
                        <div class="support_main_card_content_item">
                            <label for="#" class='primary_label2'>{{ __('common.Description') }} <span
                                    class="required_mark">*</span></label>
