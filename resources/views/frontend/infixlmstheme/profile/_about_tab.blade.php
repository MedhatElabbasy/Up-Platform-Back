            ...
            <form action="{{route('users.about.update')}}" method="POST">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <input id="job_title" name="job_title" placeholder="Ex: Sales Manager, Software Engineer"
                ...
                <div class="row">
                    <div class="col-lg-8 mt_20">
                        <div class="single_input mb_25">
                            ...
                            <small style="color: var(--system_primery_color)">The "{{__('profile.short_description') }}"
                                will be displayed at the bottom of your name on the profile cards. Keep it short (80 to
                                100 words). <span class="short_description_character_count text-danger"></span></small>
                        </div>
                    </div>
                </div>
