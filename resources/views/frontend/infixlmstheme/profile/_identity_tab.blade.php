                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input  value="{{$document->name}}"  name="ex_document_name[{{$document->id}}]" placeholder="e.g personal cv"
                                        class="primary_input4 rounded-pill document_name" {{$errors->first('name') ? 'autofocus' : ''}}
                                        type="text">
                            </div>
...
{{--                                        </button>--}}
{{--                                    </div> --}}
                                    <label for="ex_document_{{$document->id}}" class="form-uploader mb-0 ex_label_id">
                                        <input accept="image/*" data-id="{{$document->id}}" type="file" name="ex_document_{{$document->id}}" class="d-none ex_file_input_field" id="ex_document_{{$document->id}}">
                                        <span class="ex_placeholder_field" data-id="{{$document->id}}" id="exPlaceholderDocumentName_{{$document->id}}">{{__('common.Browse File')}}</span>
                                        <a class="theme_btn rounded-pill">{{__('common.Browse')}}</a>
                                    </label>
                                </div>
                            ...
                            <div class="col-lg-1">
                                <div class="position-relative form-group ">
                                    <a  href="{{route('users.document.destroy',$document->id)}}" data-repeater-delete class="link_value theme_btn small_btn4 fix-gr-bg mt-35  delete_item  mt-repeater-delete">
                                    ...
                                    <div class="row mt_20">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input  name="document_name" placeholder="e.g personal cv"
                                                   class="primary_input4 rounded-pill" {{$errors->first('name') ? 'autofocus' : ''}}
                                                    type="text">
                                        </div>
...
{{--                                                </div>--}}
                                                <label for="document_1" class="form-uploader mb-0 label_id">
                                                    <input data-id="1" type="file" name="document" class="d-none file_input_field" id="document_1">
                                                    <span class="placeholder_field" data-id="1" id="placeholderDocumentName_1">{{__('common.Browse File')}}</span>
                                                    <a class="theme_btn rounded-pill">{{__('common.Browse')}}</a>
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-lg-1">
                                            <div class="position-relative form-group ">
                                                <a  href="javascript:void(0);" data-repeater-delete class="link_value theme_btn small_btn4 fix-gr-bg mt-32 mt-repeater-delete">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <a href="javascript:void(0);" data-repeater-create class="link_value theme_btn small_btn4 mt-repeater-add document_add "><i class="fa fa-plus mr-1"></i>{{__('common.Add More')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
